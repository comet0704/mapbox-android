...
// TODO Mapbox 변경 - LineAnnotation(경로, VICS)의 경우 심볼과 마커보다 아래에 표시하기 위해 스타일에 추가한 레이어의 ID
const std::string AnnotationManager::ShapeBeforeLayerID = "kr.co.geosoft.custom.shape";
