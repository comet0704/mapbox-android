...
// TODO 혼방 지도 URL
constexpr const char* API_BASE_URL = "https://vectormap-stg.life-ranger.jp/GeoMap/"; // 테섭 지도
//constexpr const char* API_BASE_URL = "https://vectormap.life-ranger.jp/GeoMap/"; // 혼방 지도
