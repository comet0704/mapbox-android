...
public interface LocationEngine {
   ...
   *
   * @param request  {@link com.mapbox.mapboxcore.location.LocationEngineRequest} for the updates.
   * @param callback {@link LocationEngineCallback} for the location result {@link LocationEngineResult}.
   ...
   */
  @RequiresPermission(anyOf = {ACCESS_COARSE_LOCATION, ACCESS_FINE_LOCATION})
  void requestLocationUpdates(@NonNull com.mapbox.mapboxcore.location.LocationEngineRequest request,
