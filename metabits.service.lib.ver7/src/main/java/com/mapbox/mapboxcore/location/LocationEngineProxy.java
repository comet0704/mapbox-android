...
import static com.mapbox.mapboxcore.location.Utils.checkNotNull;

class LocationEngineProxy<T> implements LocationEngine {
  private final com.mapbox.mapboxcore.location.LocationEngineImpl<T> locationEngineImpl;
  private Map<LocationEngineCallback<LocationEngineResult>, T> listeners;

  LocationEngineProxy(com.mapbox.mapboxcore.location.LocationEngineImpl<T> locationEngineImpl) {
