 ...
 */
class GoogleLocationEngineImpl implements com.mapbox.mapboxcore.location.LocationEngineImpl<LocationCallback> {
  ...
  @NonNull
  @Override
  public LocationCallback createListener(com.mapbox.mapboxcore.location.LocationEngineCallback<com.mapbox.mapboxcore.location.LocationEngineResult> callback) {
  ...
  private static LocationRequest toGMSLocationRequest(com.mapbox.mapboxcore.location.LocationEngineRequest request) {
  ...
  private static final class GoogleLocationEngineCallbackTransport extends LocationCallback {
    ...
    GoogleLocationEngineCallbackTransport(com.mapbox.mapboxcore.location.LocationEngineCallback<com.mapbox.mapboxcore.location.LocationEngineResult> callback) {
    ...
    public void onLocationResult(LocationResult locationResult) {
      ...
      if (!locations.isEmpty()) {
        callback.onSuccess(com.mapbox.mapboxcore.location.LocationEngineResult.create(locations));
      } else {
  ...
  static final class GoogleLastLocationEngineCallbackTransport
    ...
    public void onSuccess(Location location) {
      callback.onSuccess(location != null ? com.mapbox.mapboxcore.location.LocationEngineResult.create(location) :
