...
public class Style {
   ...
   * improve the style.
   */
  // TODO Mapbox 변경 - Mapbox의 기본 스타일을 주석처리하고 아래에서 지오소프트의 스타일로 대체
  ...
  //-------------------------------------------------------------------------
  // TODO Mapbox 변경 - Geosoft Style 관련 추가
  //-------------------------------------------------------------------------
  public static final String MAPBOX_STREETS = "geomap://styles/geomap/streets-v1";

  public static boolean NIGHT_MODE = false;

  static final String GEOMAP_STREETS_BASE = "geomap://styles/geomap/streets-v%d";
  static final String GEOMAP_STREETS_NIGHT_BASE = "geomap://styles/geomap/streets-night-v%d";

  // car
  static final String GEOMAP_NAVI_BASE = "geomap://styles/geomap/streets-car-v%d";
  static final String GEOMAP_NAVI_NIGHT_BASE = "geomap://styles/geomap/streets-night-car-v%d";

  public static String getGeosStreetsUrl(int version) {
      NIGHT_MODE = false;
      return String.format(MapboxConstants.MAPBOX_LOCALE, GEOMAP_STREETS_BASE, version);
  }

  public static String getGeosStreetsNightUrl(int version) {
      NIGHT_MODE = true;
      return String.format(MapboxConstants.MAPBOX_LOCALE, GEOMAP_STREETS_NIGHT_BASE, version);
  }

  public static String getGeosNaviUrl(int version) {
      NIGHT_MODE = false;
      return String.format(MapboxConstants.MAPBOX_LOCALE, GEOMAP_NAVI_BASE, version);
  }

  public static String getGeosNaviNightUrl(int version) {
      NIGHT_MODE = true;
      return String.format(MapboxConstants.MAPBOX_LOCALE, GEOMAP_NAVI_NIGHT_BASE, version);
  }
  //-------------------------------------------------------------------------
