...
public class MapboxMapOptions implements Parcelable {
  ...
  public static MapboxMapOptions createFromAttributes(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    try {
      ...
      // TODO Mapbox 변경 : defValue를 false로
      mapboxMapOptions.compassEnabled(typedArray.getBoolean(R.styleable.mapbox_MapView_mapbox_uiCompass, false));	
      ...
      // TODO Mapbox 변경 : defValue를 false로
      mapboxMapOptions.logoEnabled(typedArray.getBoolean(R.styleable.mapbox_MapView_mapbox_uiLogo, false));
      ...
      mapboxMapOptions.attributionEnabled(typedArray.getBoolean(
        R.styleable.mapbox_MapView_mapbox_uiAttribution, false));
