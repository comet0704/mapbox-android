...
public final class UiSettings {
  ...
  // TODO Mapbox 변경
  private boolean isVicsDrawable;
  ...
  //-------------------------------------------------------------------------
  // TODO Mapbox 변경 - ScopeView, Vics 관련 함수들 추가
  //-------------------------------------------------------------------------
  public View getScopeView() {
      return scopeView;
  }

  public void setScopeView(View scopeView) {
      this.scopeView = scopeView;
  }

  public void setScopeViewVisible(boolean isVisible) {
      if (scopeView != null) {
          scopeView.setVisibility(isVisible ? View.VISIBLE : View.INVISIBLE);
      }
  }

  public void setVicsDrawEnable(boolean isVicsDrawable) {
      this.isVicsDrawable = isVicsDrawable;
  }

  public boolean isVicsDrawEnable() {
      return this.isVicsDrawable;
  }
  //-------------------------------------------------------------------------
